...
if (isset($_POST['submit'])) {
  ...
  $updatequery = mysql_query("UPDATE young_abstract set title='$abstitle', abstract='$abstract', keywords='$keywords', valid='yes', subtheme='$subtheme', abstract_id='$abstract_id' WHERE uid='$uid'");
  if ($updatequery) {
    $updatequery = mysql_query("UPDATE registrations set young_submission='submitted' WHERE uid='$uid'");
