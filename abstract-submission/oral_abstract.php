...
if (isset($_POST['submit'])) {
  ...
  $updatequery = mysql_query("UPDATE oral_abstract set title='$abstitle', abstract='$abstract', keywords='$keywords', valid='yes', subtheme='$subtheme', abstract_id='$abstract_id' WHERE uid='$uid'");
  if ($updatequery) {
    $updatequery = mysql_query("UPDATE registrations set oral_submission='submitted' WHERE uid='$uid'");
