          ...
          <div class="col-lg-2 col-md-2 col-sm-2">
            ...
            */
                ...
                if($oral=="nil"){
                 ...
                 <?php include("oral-list.php"); ?>
                    
                    
                    <?php
                  }
                  else{
                    echo $oral_submission;
                    ?>
                   <!-- <a id="review" target="_blank" href="oral-presentation-abstract">View</a>-->
                    <?php
                  }
                ...
                if($poster=="nil"){
                 ...
                 <?php include("poster-list.php"); ?>
                    ...
                    echo $poster_submission;
                     ?>
                    <!--<a id="review" target="_blank" href="poster-presentation-abstract">View</a>-->
                    <?php
                  }
                ...
                if($young=="nil"){
                 ...
                 <?php include("young-list.php"); ?>
                    
                    
                    <?php
                  }
                  else{
                   echo $young_submission;
                    ?>
                    <!--<a id="review" target="_blank" href="young-scientist-abstract">View</a>-->
                    <?php
                  }
              ...
              <p>1. Abstract submission started.<br>
                2. Please review your abstract before submitting. No changes will we entertained afterwards.<br>
...
<?php
include("include/connection.php");
$queryoral = mysql_query("DELETE  FROM oral_abstract WHERE valid='no'");
$queryposter = mysql_query("DELETE  FROM poster_abstract WHERE valid='no'");
$queryyoung = mysql_query("DELETE  FROM young_abstract WHERE valid='no'");
?>
<?php
